...
こちらは私が作成に携わったすべてのドキュメントです。プロジェクトの説明、文法基準、ドキュメント翻訳などが含まれています。下記のオプションからクリックしてジャンプできます。
...
{{< cards >}}
  {{< card link="./dcc-script" title="DCC文法と使用説明">}}
  {{< card link="./ftxui中国語翻訳" title="FTXUIドキュメント 簡体字中国語翻訳">}}
  {{< card link="./プログラミング言語の開発史と選定" title="研究学習レポート">}}
{{< /cards >}}