...
tags: ["软件", "环境配置","安装","新人向","教程"]  # 文章标签，用于分类和关联
categories: ["环境"]  # 文章分类
comments: true
date: 2025-11-01
authors:
...
此时打开软件，会发现音乐无法播放，这是因为这个软件被腾讯发过律师函，因此不敢提供音源，只能做一个壳子，真音源需要自己找
...
新手教程：[[新手必读] Office Tool Plus 入门教程 - Yerong の小窝](https://blog.yerong.org/archives/42)
