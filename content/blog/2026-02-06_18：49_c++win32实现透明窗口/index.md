...
> [!important]
> 本文默认读者具备基础的WIN32开发知识并基本掌握C++语法，会略过一些基础内容，如果在这两方面有一个是几乎完全没有涉及的，后期会有专门的版本来讲解（我保证九十年之内绝对会写）

> [!Warning]
> 本文所有编译均采取g++，MSVC等其他编译器用户请自行调整。  
...
> 后附：不是哥们这才几个月？这文章直接就全网蒸发了链接打不开搜也搜不到，我绝望了
...
> [!important]
> 如果使用自定义图片做背景，一定要注意尺寸不能太大，如果实在要用，请更换为[增加智能大小调控的版本](#更智能的版本)
